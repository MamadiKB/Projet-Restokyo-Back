 ...
 */
final class Version20220616123338 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, establishment_id INT NOT NULL, user_id INT NOT NULL, published_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', content LONGTEXT NOT NULL, rating NUMERIC(3, 1) DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, INDEX IDX_9474526C8565851 (establishment_id), INDEX IDX_9474526CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE establishment (id INT AUTO_INCREMENT NOT NULL, district_id INT NOT NULL, name VARCHAR(100) NOT NULL, type VARCHAR(255) DEFAULT NULL, description VARCHAR(100) NOT NULL, address VARCHAR(200) NOT NULL, price INT DEFAULT NULL, useful_info LONGTEXT DEFAULT NULL, website VARCHAR(255) DEFAULT NULL, phone INT DEFAULT NULL, rating NUMERIC(3, 1) DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, status INT NOT NULL, opening_time VARCHAR(200) NOT NULL, INDEX IDX_DBEFB1EEB08FA272 (district_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
