 ...
 */
final class Version20220615093508 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE establishment (id INT AUTO_INCREMENT NOT NULL, district_id INT NOT NULL, opening_time_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, type VARCHAR(255) DEFAULT NULL, description VARCHAR(100) NOT NULL, address VARCHAR(200) NOT NULL, price INT DEFAULT NULL, opening_days LONGTEXT DEFAULT NULL, noon_opening_time LONGTEXT DEFAULT NULL, evening_opening_time LONGTEXT DEFAULT NULL, website VARCHAR(255) DEFAULT NULL, phone INT DEFAULT NULL, rating NUMERIC(3, 1) DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, status INT NOT NULL, INDEX IDX_DBEFB1EEB08FA272 (district_id), INDEX IDX_DBEFB1EE6A8073BB (opening_time_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
